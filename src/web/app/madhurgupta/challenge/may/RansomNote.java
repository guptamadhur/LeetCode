package web.app.madhurgupta.challenge.may;
/*
# Author: Madhur Gupta
...
public class RansomNote {
    public boolean findLCSLength(String s1, String s2) {
        ...
        for (int i = 0; i < s1.length(); i++) // initialize all values with '-1'
            for (int j = 0; j < s2.length(); j++)
                dp[i][j] = -1;
        return findLCSLengthAux(dp, s1, s2, 0, 0) > 1;
    }//end of method
    ...
    public static void main(String[] args) {
        RansomNote lcs = new RansomNote();
        System.out.println(lcs.findLCSLength("fihjjjjei", "hjibagacbhadfaefdjaeaebgi"));
        System.out.println(lcs.findLCSLength("fihjjjjei", "hjibagacbhadfaefdjaeaebgi"));
    }//end of method
}//end of class
